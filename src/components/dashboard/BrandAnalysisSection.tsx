              ...
              <TooltipProvider delayDuration={200}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="mb-6 cursor-help">
                      <div className="flex items-center gap-1.5 mb-1">
                        <p className="text-[11px] font-medium tracking-[0.08em] uppercase" style={{ color: '#86868B' }}>PRODUCTS TRACKED</p>
                  ...
                  <TooltipContent 
                    side="right" 
                    sideOffset={12}
                    className="max-w-[240px] p-3 text-[12px] leading-relaxed z-[100]"
                  >
                    <p className="font-medium mb-1.5">What counts toward your limit?</p>
                    <p className="text-muted-foreground mb-2">Each product you add for AI visibility tracking counts as one slot. Archived products don't count.</p>
                    <p className="font-medium mb-1.5">At the limit?</p>
                    <p className="text-muted-foreground">You'll need to remove a product or upgrade your plan to track more.</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
              <div className="mb-6">
