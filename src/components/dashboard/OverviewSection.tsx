            ...
            <div className="mt-2">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="relative group w-16 h-8">
                    ...
                    <div className="relative h-8 w-16 transition-all duration-700 ease-out group-hover:w-60">
                      <img 
                      ...
                      <img 
                        ...
                        alt="Grok" 
                        className="absolute top-0 w-8 h-8 object-contain group-hover:left-16 group-hover:transform group-hover:scale-110 hover:!scale-125 hover:z-50 cursor-pointer" 
                        style={{ 
                          left: '14px', 
                          zIndex: 13,
                          transition: 'all 0.6s cubic-bezier(0.4, 0, 0.2, 1)',
                      ...
                      <img 
                        ...
                        alt="Gemini" 
                        className="absolute top-0 w-8 h-8 object-contain group-hover:left-32 group-hover:transform group-hover:scale-110 hover:!scale-125 hover:z-50 cursor-pointer" 
                        style={{ 
                          left: '28px', 
                          zIndex: 12,
                          transition: 'all 0.6s cubic-bezier(0.4, 0, 0.2, 1)',
